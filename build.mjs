...
<body>
  ...
  <script type="text/babel">
    ...
    // Shim lucide-react named exports — wraps vanilla lucide icon-node arrays into React components
    const _li = (nodes) => Array.isArray(nodes)
      ? ({ size = 24, color = 'currentColor', strokeWidth = 2, style, ...r }) =>
          ...
          }, nodes.map(([tag, a], i) => React.createElement(tag, { key: i, ...a })))
      : () => null;
