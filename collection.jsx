...
const SEED_ITEMS = [
  ...
  { id: 'magneto-prestige', name: 'Magneto 1:3 Prestige — Premier Edition', franchise: 'Marvel (X-Men)', studio: 'XM Studios', category: '1:3 Prestige Statue', edition: 'Premier Edition (Legendary Beast)', rarityTier: 'T3', productionRun: 699, msrp: 2999, itemCost: 1199.60, totalPaid: 1199.60, marketLow: 1800, marketMid: 2200, marketHigh: 2600, marketSource: 'verified', liquidity: 'medium', savingsMethods: ['sale', 'black-friday'], notes: 'Piece #243/699. Actual measured product weight provided by owner: 65 lbs. Replaces previous 115 lb shipping/proxy estimate. Dimensions remain approx 87 cm / 34.25 in H, 74 cm / 29.13 in W, 56 cm / 22.05 in D.', url: 'https://xm-studios.com/guest/shop/detail/magneto-premier-edition-prestige-series', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/magneto-prestige.jpg', purchaseDate: '2026-05-23', releaseDate: null, editionNumber: '243', acquisitionDate: null, dimensions: { heightIn: 34.25, widthIn: 29.13, depthIn: 22.05, weightLbs: 65.0 }, status: 'owned' },
  ...
  { id: 'cyclops', name: 'Cyclops Premium Format', franchise: 'Marvel (X-Men)', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T4', productionRun: 1200, msrp: 850, itemCost: 850, totalPaid: 1007.73, marketLow: 750, marketMid: 900, marketHigh: 1150, marketSource: 'estimated', liquidity: 'high', savingsMethods: [], notes: 'Pre-order. X-Men character = strong demand. Weight updated to 21.4 lbs.', url: 'https://www.sideshow.com/collectibles/marvel-cyclops-sideshow-collectibles-300878', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/cyclops.jpg', purchaseDate: '2025-07-31', releaseDate: null, editionNumber: '89', acquisitionDate: null, dimensions: { heightIn: 23.25, widthIn: 20.0, depthIn: 20.0, weightLbs: 21.4}, status: 'owned' },
