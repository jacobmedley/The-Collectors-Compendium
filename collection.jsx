...
const SEED_ITEMS = [
  ...
  { id: 'white-vision', name: 'White Vision 1:4 Legacy Replica', franchise: 'Marvel (WandaVision)', studio: 'Iron Studios', category: '1:4 Legacy Replica Statue', edition: 'Limited Edition', rarityTier: 'T2', productionRun: 120, msrp: 1035, itemCost: 621, totalPaid: 718.02, marketLow: 1200, marketMid: 1650, marketHigh: 2200, marketSource: 'estimated', liquidity: 'medium', savingsMethods: ['sale', 'free-bonus'], notes: '1:4 Legacy Replica. Bundle with free Spider-Man Stealth.', url: 'https://www.sideshow.com/collectibles/marvel-white-vision-iron-studios-909938', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/white-vision.jpg', purchaseDate: '2025-11-28', releaseDate: null, editionNumber: '096', acquisitionDate: null, dimensions: { heightIn: 27.6, widthIn: 14.6, depthIn: 14.1, weightLbs: null }, status: 'owned' },
  { id: 'cyclops', name: 'Cyclops Premium Format', franchise: 'Marvel (X-Men)', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T4', productionRun: 1200, msrp: 850, itemCost: 850, totalPaid: 1007.73, marketLow: 750, marketMid: 900, marketHigh: 1150, marketSource: 'estimated', liquidity: 'high', savingsMethods: [], notes: 'X-Men character = strong demand.', url: 'https://www.sideshow.com/collectibles/marvel-cyclops-sideshow-collectibles-300878', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/cyclops.jpg', purchaseDate: '2025-07-31', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 23.25, widthIn: 20.0, depthIn: 20.0, weightLbs: null }, status: 'owned' },
  { id: 'killer-croc', name: 'Killer Croc Premium Format', franchise: 'DC Comics', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T5', productionRun: null, msrp: 850, itemCost: 802.30, totalPaid: 944, marketLow: 800, marketMid: 950, marketHigh: 1200, marketSource: 'estimated', liquidity: 'medium', savingsMethods: ['rewards'], notes: 'Payment plan. Est. total ~$1,025.', url: 'https://www.sideshow.com/collectibles/dc-comics-killer-croc-sideshow-collectibles-300914', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/killer-croc.jpg', purchaseDate: '2026-05-12', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 22.44, widthIn: 24.44, depthIn: 21.25, weightLbs: null }, status: 'payment-plan' },
  { id: 'succubus', name: 'Succubus Premium Format', franchise: 'Sideshow Originals', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T4', productionRun: 1300, msrp: 650, itemCost: 630, totalPaid: 790.63, marketLow: 550, marketMid: 700, marketHigh: 900, marketSource: 'estimated', liquidity: 'low', savingsMethods: ['sale'], notes: 'Payment plan. Sideshow Original IP = smaller resale market.', url: 'https://www.sideshow.com/collectibles/sideshow-originals-succubus-sideshow-collectibles-300844', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/succubus.jpg', purchaseDate: '2026-03-05', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 30.5, widthIn: 16.2, depthIn: 10.4, weightLbs: null }, status: 'payment-plan' },
...
const RARITY_TIERS = {
  T1: { label: 'Ultra Rare (<50)',   short: 'Ultra Rare', rpg: 'Artifact',   color: '#E05050' },
  T2: { label: 'Very Rare (50–249)', short: 'Very Rare',  rpg: 'Legendary',  color: '#FF8C00' },
  T3: { label: 'Rare (250–999)',     short: 'Rare',       rpg: 'Epic',       color: '#A335EE' },
  T4: { label: 'Limited (1k–2.5k)', short: 'Limited',    rpg: 'Rare',       color: '#0090FF' },
  T5: { label: 'Wide (2.5k–10k)',   short: 'Wide',       rpg: 'Uncommon',   color: '#1EFF00' },
  T6: { label: 'Mass (10k+)',        short: 'Mass',       rpg: 'Common',     color: '#9D9D9D' },
...
const SORT_OPTIONS = [
  { key: 'name', label: 'Name' }, { key: 'msrp', label: 'MSRP' }, { key: 'itemCost', label: 'Item Paid' },
  { key: 'totalPaid', label: 'Total OOP' }, { key: 'overhead', label: 'Overhead' },
  { key: 'marketMid', label: 'Market Value' }, { key: 'savingsAbs', label: 'Savings $' },
  { key: 'savingsPct', label: 'Savings %' }, { key: 'gainPct', label: 'Gain %' },
  { key: 'cagrPct', label: 'CAGR %' }, { key: 'holdingDays', label: 'Holding Period' },
  { key: 'releaseDate', label: 'Release Date' }, { key: 'purchaseDate', label: 'Purchase Date' },
  { key: 'rarityTier', label: 'Rarity' }, { key: 'productionRun', label: 'Production Run' },
  { key: 'liquidity', label: 'Liquidity' }, { key: 'studio', label: 'Studio' }, { key: 'franchise', label: 'Franchise' },
];
...
const TOOLTIPS = {
  ...
  rarity: "Rarity tier by production run — T1 Artifact (red, <50) → T2 Legendary (orange) → T3 Epic (purple) → T4 Rare (blue) → T5 Uncommon (green) → T6 Common (gray, 10k+). Lower = scarcer.",
  liquidity: "How easily the piece can be sold. Driven by collector base size, franchise popularity, and studio reputation.",
  ...
  releaseDate: "The manufacturer's official release date. For pre-orders, this is the estimated ship window.",
  acquisitionDate: "The date you personally received the piece.",
  editionNumber: "Your specific piece number within the edition (e.g. #068 from a run of 800).",
...
function useRemoteImage(url) {
  ...
  React.useEffect(() => {
    ...
    let alive = true;
    fetch(url).then(r => { if (!r.ok) throw r.status; return r.blob(); })
      .then(blob => new Promise((res, rej) => { const fr = new FileReader(); fr.onload = () => res(fr.result); fr.onerror = rej; fr.readAsDataURL(blob); }))
      .then(dataUrl => { _imgCache.set(url, dataUrl); if (alive) setSrc(dataUrl); })
...
const computeMetrics = (item) => {
  ...
  const savingsPct = itemCost !== null && itemCost !== undefined && msrp > 0 ? ((msrp - itemCost) / msrp) * 100 : null;
  const overhead = totalPaid !== null && totalPaid !== undefined && itemCost !== null && itemCost !== undefined ? totalPaid - itemCost : null;
...
export default function CollectionApp() {
  ...
  useEffect(() => {
    (async () => {
      try { const result = await store.get(STORAGE_KEY); if (result && result.value) setOverrides(JSON.parse(result.value)); } catch (e) {}
      setLoaded(true);
    })();
  }, []);

  const saveOverrides = async (next) => { setOverrides(next); try { await store.set(STORAGE_KEY, JSON.stringify(next)); } catch (e) {} };
  ...
  const visible = useMemo(() => {
    ...
    if (search) { const q = search.toLowerCase(); arr = arr.filter((i) => i.name.toLowerCase().includes(q) || i.franchise.toLowerCase().includes(q) || i.studio.toLowerCase().includes(q) || (i.notes || '').toLowerCase().includes(q)); }
  ...
  const totals = useMemo(() => {
    ...
    const groupBy = (key) => { const m = {}; committed.forEach((i) => { m[i[key]] = (m[i[key]] || 0) + (i.marketMid || 0); }); return Object.entries(m).sort((a, b) => b[1] - a[1]); };
  ...
  if (!loaded) return <div style={{ background: '#0a0a0b', color: '#f5f1e8', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'serif' }}>Loading…</div>;
    ...
    <div style={{ background: 'linear-gradient(180deg, #0a0a0b 0%, #111114 100%)', minHeight: '100vh', color: 'var(--c-primary)', fontFamily: '"Manrope", -apple-system, sans-serif', paddingBottom: 64 }} onClick={() => setActiveTooltip(null)}><div style={{ maxWidth: 1920, margin: '0 auto' }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; } body { margin: 0; }
        :root {
          --t-xs: clamp(10px, 0.55vw + 8.8px, 12px); --t-sm: clamp(11px, 0.65vw + 9.7px, 13px);
          --t-base: clamp(13px, 0.8vw + 11.4px, 15px); --t-md: clamp(14px, 0.9vw + 12.2px, 17px);
          --t-lg: clamp(16px, 1.1vw + 13.7px, 20px); --t-xl: clamp(18px, 1.4vw + 15px, 24px);
          --t-2xl: clamp(22px, 1.8vw + 18px, 30px);
          --c-primary: #edeae2; --c-secondary: #b2ada4; --c-muted: #9a9690; --c-dim: #848078; --c-faint: #7a7670;
          --c-gold: #d4a750; --c-gold-dim: #a07828;
          --gap-card: clamp(10px, 1.2vw, 16px); --pad-card: clamp(12px, 2vw, 18px); --r-card: 12px;
        }
        ...
        button { font-family: inherit; cursor: pointer; } select, input, textarea { font-family: inherit; }
        .stats-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: var(--gap-card); }
        .cards-grid { display: grid; grid-template-columns: 1fr; gap: var(--gap-card); }
        @media (min-width: 1024px) { .stats-grid { grid-template-columns: repeat(3, 1fr); } .cards-grid { grid-template-columns: repeat(2, 1fr); } }
        .mini-stats { display: grid; grid-template-columns: repeat(4, 1fr); gap: 5px; }
        @media (max-width: 1023px) {
          .mini-stats { display: flex; overflow-x: auto; scroll-snap-type: x mandatory; -webkit-overflow-scrolling: touch; scrollbar-width: none; gap: 5px; }
          .mini-stats::-webkit-scrollbar { display: none; }
          .mini-stats > * { flex: 0 0 calc(50% - 2.5px); min-width: 0; scroll-snap-align: start; }
        }
        .swipe-dots { display: none; justify-content: center; gap: 5px; margin-top: 7px; }
        @media (max-width: 1023px) { .swipe-dots { display: flex; } }
        .swipe-dot { width: 5px; height: 5px; border-radius: 50%; background: #3a3a40; transition: background 0.25s, transform 0.25s; cursor: pointer; }
        .swipe-dot.active { background: var(--c-gold); transform: scale(1.25); }
        button:focus-visible, a:focus-visible, select:focus-visible, input:focus-visible { outline: 2px solid #d4a750; outline-offset: 2px; }
        ::-webkit-scrollbar { height: 6px; width: 6px; } ::-webkit-scrollbar-track { background: #16161a; } ::-webkit-scrollbar-thumb { background: #3a3a40; border-radius: 3px; }
        .tooltip-pop { position: absolute; z-index: 200; }
        .tooltip-pop.align-left { left: 0; transform: none; } .tooltip-pop.align-right { right: 0; left: auto; transform: none; } .tooltip-pop.align-center { left: 50%; transform: translateX(-50%); }
        .tooltip-pop.above { bottom: 120%; top: auto; } .tooltip-pop.below { top: 120%; bottom: auto; }
      `}</style>
      ...
      <div className="cards-grid" style={{ padding: 16 }}>
        ...
        {visible.map((item) => (
          <ItemCard key={item.id} item={item} onOpenModal={() => { setModalItemId(item.id); setEditingId(null); }} activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
        ))}
      </div>
      ...
      {modalItemId && (() => {
        ...
        return (
          <DetailModal item={modalItem} editing={editingId === modalItem.id} onEdit={() => setEditingId(modalItem.id)} onCloseEdit={() => setEditingId(null)}
            onUpdate={(patch) => updateItem(modalItem.id, patch)} onReset={() => resetItem(modalItem.id)} hasOverride={!!overrides[modalItem.id]}
            onClose={() => { setModalItemId(null); setEditingId(null); }} activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} />
        );
      })()}
    </div></div>
  );
...
function InfoTooltip({ tooltipKey, activeTooltip, setActiveTooltip, anchorId }) {
  ...
  const handleOpen = (e) => {
    ...
    if (!isActive && btnRef.current) {
      ...
      if (rect.left < 140) setAlign('align-left'); else if (rect.right > window.innerWidth - 140) setAlign('align-right'); else setAlign('align-center');
      setVert(rect.bottom > window.innerHeight - 160 ? 'above' : 'below');
    }
  ...
  return (
    <span style={{ position: 'relative', display: 'inline-flex', verticalAlign: 'middle', marginLeft: 4 }}>
      <button ref={btnRef} onClick={handleOpen} style={{ background: 'transparent', border: 'none', padding: 0, display: 'inline-flex', color: isActive ? '#d4a750' : 'var(--c-faint)', cursor: 'pointer', lineHeight: 1 }} aria-label={`Info: ${tooltipKey}`} aria-expanded={isActive}>
        <Info size={11} />
      </button>
      {isActive && <div onClick={(e) => e.stopPropagation()} className={`tooltip-pop ${align} ${vert}`} style={{ minWidth: 220, maxWidth: 280, padding: '10px 13px', background: '#1c1c22', border: '1px solid #3a3020', borderRadius: 8, fontSize: 'var(--t-sm)', color: 'var(--c-secondary)', lineHeight: 1.55, boxShadow: '0 8px 28px rgba(0,0,0,0.6)', pointerEvents: 'none' }}>{text}</div>}
    </span>
  );
}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
        {items.map((it, idx) => (
          <div key={it.id} style={{ display: 'flex', justifyContent: 'space-between', fontSize: 12, padding: '4px 0', borderBottom: idx < items.length - 1 ? '1px solid #1a1a1e' : 'none' }}>
            <span style={{ color: '#d4cfc4', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '65%' }}><span style={{ color: 'var(--c-dim)', marginRight: 6 }}>{idx + 1}.</span>{it.name}</span>
  ...
  return (
    <div style={{ background: '#16161a', border: '1px solid #22222a', borderRadius: 10, padding: 'clamp(10px, 1.5vw, 14px)' }}>
      <div style={{ fontSize: 'var(--t-xs)', color: 'var(--c-faint)', letterSpacing: '0.07em', textTransform: 'uppercase', fontWeight: 600, marginBottom: 4, display: 'flex', alignItems: 'center' }}>
        {label}{tooltipKey && <InfoTooltip tooltipKey={tooltipKey} activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} anchorId={`stat-${label}`} />}
      </div>
...
function SwipeableStats({ children }) {
  ...
  const handleScroll = () => {
    ...
    setActiveDot(maxScroll > 0 ? Math.min(Math.round((el.scrollLeft / maxScroll) * (PAGES - 1)), PAGES - 1) : 0);
  };
  const goTo = (page) => {
    const el = scrollRef.current; if (!el) return;
    el.scrollTo({ left: (page / (PAGES - 1)) * (el.scrollWidth - el.clientWidth), behavior: 'smooth' });
  };
  return (
    <div style={{ marginTop: 10 }}>
      <div ref={scrollRef} className="mini-stats" onScroll={handleScroll}>{children}</div>
      <div className="swipe-dots" role="tablist" aria-label="Stats pages">
        {Array.from({ length: PAGES }).map((_, i) => (
          <span key={i} role="tab" aria-selected={i === activeDot} onClick={() => goTo(i)} className={`swipe-dot${i === activeDot ? ' active' : ''}`} />
        ))}
      </div>
    </div>
  );
...
function ItemCard({ item, onOpenModal, activeTooltip, setActiveTooltip }) {
  ...
  const gc = (() => {
    if (item.savingsMethods.includes('gift') || (item.savingsMethods.includes('free-bonus') && item.itemCost === 0)) return { bg: 'rgba(28,21,8,0.85)', border: '#50401a', text: '#d4a750' };
    if (!item.gainPct || item.totalPaid === 0) return { bg: 'rgba(20,20,24,0.85)', border: '#2c2c34', text: 'var(--c-muted)' };
    ...
    <div style={{ background: '#131316', border: '1px solid #252530', borderRadius: 'var(--r-card)', overflow: 'hidden', transition: 'border-color 0.2s', display: 'flex', flexDirection: 'column' }}>
      <div onClick={onOpenModal} style={{ display: 'flex', cursor: 'pointer', flex: 1, minHeight: 0 }}>
        <div style={{ position: 'relative', flexShrink: 0, width: 'clamp(140px, 28vw, 240px)', aspectRatio: '1 / 1', background: '#1a1a22', overflow: 'hidden' }}>
          {imgUrl && !imgErr
            ? <img src={imgUrl} alt={item.name} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} loading="lazy" onError={() => setImgErr(true)} />
            : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: `radial-gradient(ellipse at center, ${tier.color}18 0%, transparent 70%)` }}><span className="display" style={{ fontSize: 'clamp(40px, 7vw, 70px)', color: tier.color, opacity: 0.3, userSelect: 'none' }}>{item.franchise.charAt(0)}</span></div>
          }
          <div style={{ position: 'absolute', top: 8, left: 8, padding: '4px 10px', background: 'rgba(8,8,10,0.82)', backdropFilter: 'blur(6px)', borderRadius: 6, border: `1px solid ${tier.color}55`, fontSize: 'var(--t-xs)', fontWeight: 800, color: tier.color, letterSpacing: '0.06em', lineHeight: 1 }}>{item.rarityTier}</div>
          {(() => {
            const badges = [];
            ...
            if (item.savingsMethods.includes('free-bonus') && item.itemCost === 0) badges.push({ icon: <Percent size={13} />, color: '#d4a750', border: '#50401a', title: 'Free Bonus' });
            if (badges.length === 0) return null;
            return <div style={{ position: 'absolute', bottom: 8, left: 8, display: 'flex', gap: 4 }}>{badges.map((b, i) => <div key={i} title={b.title} style={{ ...iconStyle, color: b.color, border: `1px solid ${b.border}` }}>{b.icon}</div>)}</div>;
          })()}
        </div>
              ...
              {leBadge ? (
                <>
                  ...
                  <span className="mono" style={{ padding: '4px 9px', background: tier.color + '10', border: `1px solid ${tier.color}50`, borderLeft: `1px solid ${tier.color}30`, borderRadius: '0 6px 6px 0', fontSize: 'var(--t-xs)', fontWeight: 600, color: tier.color, letterSpacing: '0.04em', lineHeight: 1.4, whiteSpace: 'nowrap', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                    {leBadge}{item.marketSource === 'verified' && <CheckCircle2 size={10} style={{ opacity: 0.75, flexShrink: 0 }} title="Market value verified" />}
                  </span>
                </>
              ) : (
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '4px 9px', background: tier.color + '18', border: `1px solid ${tier.color}45`, borderRadius: 6, fontSize: 'var(--t-xs)', fontWeight: 700, color: tier.color + 'cc', letterSpacing: '0.05em' }}>
                  {tier.short}{item.marketSource === 'verified' && <CheckCircle2 size={10} style={{ opacity: 0.75 }} />}
                </span>
              )}
            </div>
...
function DetailModal({ item, editing, onEdit, onCloseEdit, onUpdate, onReset, hasOverride, onClose, activeTooltip, setActiveTooltip }) {
  ...
  const [imgErr, setImgErr] = useState(false);
  const leBadge = item.productionRun ? (item.editionNumber ? `${String(item.editionNumber).padStart(String(item.productionRun).length, '0')}/${item.productionRun.toLocaleString()}` : item.productionRun.toLocaleString()) : null;
  const handleBackdropClick = useCallback((e) => { if (e.target === e.currentTarget) onClose(); }, [onClose]);
  useEffect(() => { const h = (e) => { if (e.key === 'Escape') onClose(); }; window.addEventListener('keydown', h); return () => window.removeEventListener('keydown', h); }, [onClose]);
  useEffect(() => { const prev = document.body.style.overflow; document.body.style.overflow = 'hidden'; return () => { document.body.style.overflow = prev; }; }, []);

  return (
    <div onClick={handleBackdropClick} style={{ position: 'fixed', inset: 0, zIndex: 1000, background: 'rgba(0,0,0,0.72)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
      <div style={{ position: 'relative', width: '100%', maxWidth: 680, maxHeight: '92dvh', background: '#0e0e12', border: `1px solid ${tier.color}30`, borderRadius: '20px 20px 0 0', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div style={{ position: 'relative', flexShrink: 0, height: 200, background: '#1a1a22', overflow: 'hidden' }}>
          {imgUrl && !imgErr
            ? <img src={imgUrl} alt={item.name} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} onError={() => setImgErr(true)} />
            : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: `radial-gradient(ellipse at center, ${tier.color}18 0%, transparent 70%)` }}><span className="display" style={{ fontSize: 80, color: tier.color, opacity: 0.2, userSelect: 'none' }}>{item.franchise.charAt(0)}</span></div>
          }
          <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, height: 80, background: 'linear-gradient(transparent, #0e0e12)' }} />
          <button onClick={onClose} style={{ position: 'absolute', top: 12, right: 12, width: 34, height: 34, background: 'rgba(8,8,10,0.75)', backdropFilter: 'blur(8px)', border: '1px solid #3a3a40', borderRadius: '50%', color: 'var(--c-muted)', display: 'flex', alignItems: 'center', justifyContent: 'center' }} aria-label="Close"><X size={16} /></button>
          <div style={{ position: 'absolute', top: 12, left: 12, padding: '4px 10px', background: 'rgba(8,8,10,0.82)', backdropFilter: 'blur(6px)', borderRadius: 6, border: `1px solid ${tier.color}55`, fontSize: 11, fontWeight: 800, color: tier.color, letterSpacing: '0.06em' }}>{item.rarityTier}</div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '16px 16px 32px' }}>
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
            ...
            {item.status !== 'owned' && <span style={{ padding: '4px 10px', background: '#1a1a2e', border: '1px solid #3a3a60', borderRadius: 6, fontSize: 11, color: '#8a9acd' }}>{STATUS_LABELS[item.status]}</span>}
          </div>
          ...
          {!editing ? (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
                ...
                {item.releaseDate ? <DetailRow label="Release Date" value={new Date(item.releaseDate).toLocaleDateString('en-US', {year:'numeric', month:'short', day:'numeric'})} tooltipKey="releaseDate" activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} anchorId={`${item.id}-rd-m`} />
  ...
  return (
    <div style={{ background: '#1a1a22', border: '1px solid #28283200', borderRadius: 8, padding: '8px 10px' }}>
      <div style={{ fontSize: 'var(--t-xs)', color: 'var(--c-faint)', letterSpacing: '0.07em', textTransform: 'uppercase', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 2, marginBottom: 4, whiteSpace: 'nowrap' }}>
        {label}{tooltipKey && <InfoTooltip tooltipKey={tooltipKey} activeTooltip={activeTooltip} setActiveTooltip={setActiveTooltip} anchorId={anchorId} />}
      </div>
...
function EditForm({ item, onUpdate, onClose }) {
  ...
  const save = () => {
    onUpdate({
      ...
      dimensions: { heightIn: dimH === '' ? null : parseFloat(dimH), widthIn: dimW === '' ? null : parseFloat(dimW), depthIn: dimD === '' ? null : parseFloat(dimD), weightLbs: dimWt === '' ? null : parseFloat(dimWt) },
    });
    onClose();
  };
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
        ...
        <div>
          ...
          <select value={marketSource} onChange={(e) => setMarketSource(e.target.value)} style={inputStyle}>
            <option value="verified">Verified</option><option value="estimated">Estimated</option>
          </select>
        </div>
        <div>
