...
const SEED_ITEMS = [
  { id: 'ultra-magnus', name: 'Ultra Magnus — Premium Limited Edition', franchise: 'Transformers (Bumblebee)', studio: 'Threezero', category: 'Action Figure', edition: 'Premium Limited Edition', rarityTier: 'T3', productionRun: 1200, msrp: 539.99, itemCost: 539.99, totalPaid: 539.99, marketLow: 480, marketMid: 580, marketHigh: 720, marketSource: 'estimated', liquidity: 'medium', savingsMethods: [], notes: 'BBTS exclusive.', url: 'https://www.bigbadtoystore.com/product/transformers-bumblebee-premium-ultra-magnus-limited-edition-action-figure-176242', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/ultra-magnus.jpg', purchaseDate: '2026-05-08', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 19.0, widthIn: null, depthIn: null, weightLbs: null }, status: 'owned' },
  { id: 'darkseid', name: 'Darkseid Maquette — Exclusive Edition', franchise: 'DC Comics', studio: 'Sideshow Collectibles', category: 'Maquette', edition: 'Exclusive (alternate portrait)', rarityTier: 'T3', productionRun: 1000, msrp: 660, itemCost: 460, totalPaid: 494.34, marketLow: 600, marketMid: 750, marketHigh: 950, marketSource: 'estimated', liquidity: 'high', savingsMethods: ['sale', 'free-bonus'], notes: 'Edition #767/1,000. Bundle with free Iron Man Neon. Bundle subtotal $1,070, discount -$608, total $494.34. Weight 25 lbs (owner-weighed).', url: 'https://www.sideshow.com/collectibles/dc-comics-darkseid-sideshow-collectibles-200581', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/darkseid.jpg', purchaseDate: '2024-12-02', releaseDate: null, editionNumber: '767', acquisitionDate: null, dimensions: { heightIn: 24.0, widthIn: 16.0, depthIn: 10.0, weightLbs: 25.0}, status: 'owned' },
  ...
  { id: 'batgirl', name: 'Batgirl Premium Format', franchise: 'DC Comics', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T3', productionRun: 2200, msrp: 720, itemCost: 720, totalPaid: 851.94, marketLow: 650, marketMid: 800, marketHigh: 1000, marketSource: 'estimated', liquidity: 'high', savingsMethods: [], notes: 'No discounts. Tariff $28.80, tax $50.40, ship $52.74.', url: 'https://www.sideshow.com/collectibles/dc-comics-batgirl-premium-format-figure-sideshow-collectibles-300854', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/batgirl.jpg', purchaseDate: '2025-05-30', releaseDate: null, editionNumber: '1829', acquisitionDate: '2025-08-23', dimensions: { heightIn: 21.5, widthIn: 15.0, depthIn: 14.0, weightLbs: 17.0 }, status: 'owned' },
  ...
  { id: 'white-vision', name: 'White Vision 1:4 Legacy Replica', franchise: 'Marvel (WandaVision)', studio: 'Iron Studios', category: '1:4 Legacy Replica Statue', edition: 'Limited Edition', rarityTier: 'T1', productionRun: 120, msrp: 1035, itemCost: 621, totalPaid: 718.02, marketLow: 1200, marketMid: 1650, marketHigh: 2200, marketSource: 'estimated', liquidity: 'medium', savingsMethods: ['sale', 'free-bonus'], notes: '1:4 Legacy Replica (NOT 1:10). Bundle with free Spider-Man Stealth. Weight updated to 19 lbs.', url: 'https://www.sideshow.com/collectibles/marvel-white-vision-iron-studios-909938', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/white-vision.jpg', purchaseDate: '2025-11-28', releaseDate: null, editionNumber: '096', acquisitionDate: null, dimensions: { heightIn: 27.6, widthIn: 14.6, depthIn: 14.1, weightLbs: 19.0}, status: 'owned' },
  { id: 'cyclops', name: 'Cyclops Premium Format', franchise: 'Marvel (X-Men)', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T3', productionRun: 1200, msrp: 850, itemCost: 850, totalPaid: 1007.73, marketLow: 750, marketMid: 900, marketHigh: 1150, marketSource: 'estimated', liquidity: 'high', savingsMethods: [], notes: 'Pre-order. X-Men character = strong demand. Weight updated to 21.4 lbs.', url: 'https://www.sideshow.com/collectibles/marvel-cyclops-sideshow-collectibles-300878', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/cyclops.jpg', purchaseDate: '2025-07-31', releaseDate: null, editionNumber: '89', acquisitionDate: null, dimensions: { heightIn: 23.25, widthIn: 20.0, depthIn: 20.0, weightLbs: 21.4}, status: 'owned' },
  { id: 'killer-croc', name: 'Killer Croc Premium Format', franchise: 'DC Comics', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T3', productionRun: null, msrp: 850, itemCost: 802.30, totalPaid: 944, marketLow: 800, marketMid: 950, marketHigh: 1200, marketSource: 'estimated', liquidity: 'medium', savingsMethods: ['rewards'], notes: 'Payment plan. Est. total ~$1,025 (tariff ~$20, tax ~$65, ship ~$90). Weight TBD until item ships.', url: 'https://www.sideshow.com/collectibles/dc-comics-killer-croc-sideshow-collectibles-300914', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/killer-croc.jpg', purchaseDate: '2026-05-12', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 22.44, widthIn: 24.44, depthIn: 21.25, weightLbs: null }, status: 'payment-plan' },
  { id: 'succubus', name: 'Succubus Premium Format', franchise: 'Sideshow Originals', studio: 'Sideshow Collectibles', category: 'Premium Format Figure', edition: 'Standard', rarityTier: 'T3', productionRun: 1300, msrp: 650, itemCost: 630, totalPaid: 790.63, marketLow: 550, marketMid: 700, marketHigh: 900, marketSource: 'estimated', liquidity: 'low', savingsMethods: ['sale'], notes: 'Sideshow Original IP = smaller resale market. Weight updated to 23.40 lbs (shipping/online estimate).', url: 'https://www.sideshow.com/collectibles/sideshow-originals-succubus-sideshow-collectibles-300844', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/succubus.jpg', purchaseDate: '2026-03-05', releaseDate: null, editionNumber: '0364', acquisitionDate: '2026-06-27', dimensions: { heightIn: 30.5, widthIn: 16.2, depthIn: 10.4, weightLbs: 23.4}, status: 'owned' },
  { id: 'miss-fortune', name: 'The Bounty Hunter — Miss Fortune', franchise: 'League of Legends', studio: 'Jimei Palace', category: 'Statue', edition: 'Standard', rarityTier: 'T3', productionRun: null, msrp: 550, itemCost: 483.10, totalPaid: 516.92, marketLow: 500, marketMid: 600, marketHigh: 750, marketSource: 'estimated', liquidity: 'low', savingsMethods: ['rewards'], notes: 'Rewards -$66.90. Pre-order.', url: 'https://www.sideshow.com/collectibles/league-of-legends-the-bounty-hunter-miss-fortune-jimei-palace-915012', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/miss-fortune.jpg', purchaseDate: '2025-11-16', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 16.92, widthIn: 11.41, depthIn: 7.87, weightLbs: 22.0 }, status: 'pre-order' },
  { id: 'vi', name: 'Vi (Hot Toys)', franchise: 'League of Legends', studio: 'Hot Toys', category: 'Sixth Scale Figure', edition: 'Standard', rarityTier: 'T5', productionRun: null, msrp: 280, itemCost: 280, totalPaid: 324.97, marketLow: 250, marketMid: 310, marketHigh: 400, marketSource: 'estimated', liquidity: 'medium', savingsMethods: [], notes: 'League of Legends sixth scale figure.', url: '', imageUrl: 'https://raw.githubusercontent.com/jacobmedley/The-Collectors-Compendium/main/images/thumbs/vi.jpg', purchaseDate: '2025-09-05', releaseDate: null, editionNumber: null, acquisitionDate: null, dimensions: { heightIn: 12.0, widthIn: null, depthIn: null, weightLbs: 1.0 }, status: 'owned' },
...
const RARITY_TIERS = {
  T1: { label: 'Legendary (1–250)',    short: 'Legendary', rpg: 'Legendary', color: '#FF8000' },
  T2: { label: 'Epic (251–999)',       short: 'Epic',      rpg: 'Epic',      color: '#A335EE' },
  T3: { label: 'Rare (1k–2.4k)',       short: 'Rare',      rpg: 'Rare',      color: '#0070DD' },
  T4: { label: 'Uncommon (2.5k–4.9k)', short: 'Uncommon',  rpg: 'Uncommon',  color: '#1EFF00' },
  T5: { label: 'Common (5k–9.9k)',     short: 'Common',    rpg: 'Common',    color: '#E8E4DA' },
  T6: { label: 'Mass (10k+ / Open)',   short: 'Mass',      rpg: 'Mass',      color: '#9D9D9D' },
...
const SAVINGS_LABELS = {
  ...
  'bundle': 'Bundle', 'free-shipping': 'Free Shipping', 'market-weighted-allocation': 'Mkt-Weighted Split',
};
...
const TOOLTIPS = {
  ...
  rarity: "Rarity tier by production run — T1 Legendary (orange, 1–250) is rarest → T2 Epic (purple) → T3 Rare (blue) → T4 Uncommon (green) → T5 Common (white) → T6 Mass (gray, 10k+/open). Lower tier number = scarcer = typically stronger value retention.",
...
const computeMetrics = (item) => {
  ...
  if (item.purchaseDate) {
    ...
    if (totalPaid > 0 && holdingDays > 30 && marketMid > 0) {
      cagrPct = (Math.pow(marketMid / totalPaid, 365 / holdingDays) - 1) * 100;
    }
  }
